...
urlpatterns = [
    ...
    path("api/movie/<int:pk>/premium/", views.toggle_premium, name="api_toggle_premium"),
    path("api/movie/<int:pk>/premiere/", views.toggle_premiere, name="api_toggle_premiere"),
