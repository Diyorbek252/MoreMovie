/**
 * Yagona ikonka to'plami — `templates/partials/icon.html` ning React
 * ekvivalenti. Yangi ikonka kerak bo'lsa shu ro'yxatga qo'shing, boshqa
 * joyga SVG yozmang (backend'dagi qoidaning o'zi).
 */
...
const PATHS: Record<string, React.ReactNode> = {
  ...
  star: (
    <polygon
      points="12 2 15.1 8.6 22 9.6 17 14.5 18.2 21.5 12 18.2 5.8 21.5 7 14.5 2 9.6 8.9 8.6 12 2"
      fill="currentColor"
      stroke="none"
    />
  ),
  ...
  coin: (
    <>
      ...
      <path d="M9.5 15.2c.5.7 1.4 1.1 2.5 1.1 1.7 0 3-1 3-2.3 0-3-5-1.4-5-4 0-1.3 1.3-2.3 3-2.3 1.1 0 2 .4 2.5 1.1M12 6.5v11" />
    </>
  ),
  ...
  telegram: <path d="M22 3L2 10.5l6 2.3M22 3l-3 16-6.5-5.8M22 3L8 12.8v5.4l3.5-3.9" />,
  youtube: (
    <>
      <path d="M22.5 7a2.8 2.8 0 0 0-2-2C18.8 4.5 12 4.5 12 4.5s-6.8 0-8.5.5a2.8 2.8 0 0 0-2 2A29 29 0 0 0 1 12a29 29 0 0 0 .5 5a2.8 2.8 0 0 0 2 2c1.7.5 8.5.5 8.5.5s6.8 0 8.5-.5a2.8 2.8 0 0 0 2-2 29 29 0 0 0 .5-5 29 29 0 0 0-.5-5z" />
  ...
  crown: <path d="M3 18h18M4 18l-1-9 5 4 4-7 4 7 5-4-1 9" strokeLinejoin="round" />,
  image: (
    <>
...
const FALLBACK = <circle cx="12" cy="12" r="10" />;
